...
style="min-height:110px;background-color: #fcffde; min-width: 50%">

    <div
        class="flex-shrink-0 hidden mb-2 rounded-lg shadow-lg sm:block md:mb-0 lg:absolute md:p-4 md:bg-white md:-left-9">
        <img src="https://larajobs.com/logos/46bxEYQ5qExDksLAkW6KbOoQnUm3eODo0SbiSTHP.png"
    ...
    <div class="flex flex-col w-full md:flex-row">
        <div class="flex-1 w-full min-w-0 px-2 mb-2 md:pl-6 md:mb-0" style="color:#2d3748;">
            ...
            <p class="text-sm text-gray-500 truncate" style="color:#2d3748;">Creative Force</p>
            <p class="text-lg font-bold text-gray-900" style="color:#2d3748;">Laravel Jedi</p>
